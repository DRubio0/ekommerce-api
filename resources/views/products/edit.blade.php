...
@section('content')
    <div class="flex justify-center ">
        <div class="max-w-lg mt-20 bg-white p-6 rounded-xl">
            <h1 class="text-black uppercase font-bold text-2xl text-center">Edit Product</h1>
            <form method="POST" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data"
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full md:w-1/2 mb-6 md:mb-3 md:pl-2">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="stock" type="number" name="stock" placeholder="stock"
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full md:w-1/2 md:pl-2 mb-6 md:mb-3">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="sku" type="text" name="sku" placeholder="SKU"
                ...
                <div class="flex flex-wrap">
                    <div class="w-full">
                        ...
                        <textarea
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="description" name="description" rows="5" placeholder="" value="">{{ old('description', $product->description) }}</textarea>
                        @error('description')
                            <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="relative">
                        <select
                            ...
                            @foreach ($subcategories as $subcategory)
                                <option {{ $product->id === $subcategory->id ? 'selected ' : ' ' }}
                ...
                <div class="flex justify-end">
                    ...
                    <input
                        class="bg-blue-500 p-3 rounded md:w-1/2 justify-end text-white font-bold uppercase hover:bg-blue-700 m-1 transition-colors cursor-pointer"
