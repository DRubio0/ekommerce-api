...
<div class="flex flex-col justify-center w-full items-center min-h-screen mx-auto bg-gradient-to-tr from-blue-700 via-blue-800 to-gray-900 gap-6 shadow-2xl py-12">
    ...
    {{-- <div class="flex flex-col justify-center w-full items-center min-h-screen mx-auto bg-gradient-to-tr from-blue-700 via-blue-800 to-gray-900 gap-6 shadow-2xl py-12">
        <h2 class="text-white uppercase font-bold text-xl ">Create Product</h2>
        <div class="max-w-lg bg-white p-6 rounded-xl">
            <form method="POST" action="{{ route('product.store')}}" class="w-full max-w-lg" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <textarea
                            ...
                            id="description" name="description" rows="5" placeholder=""></textarea>
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="subcategory">
                            Subcategory
                        </label>
                        <div class="relative">
                            <select
