...
@section('content')
    ...
    <div class="grid grid-cols-3 gap-4 mt-4">
        <div class="bg-blue-500 text-white p-4 rounded tex shadow-xl shadow-black">
            ...
            <p class="my-3 mb-0 ml-12 mr-12 p-2 text-2xl rounded bg-blue-600 hover:bg-blue-900 transition-colors uppercase text-center">12</p>
        </div>
        <div class="bg-green-500 text-white p-4 rounded tex shadow-xl shadow-black">
            ...
            <p class="my-3 mb-0 ml-12 mr-12 p-2 text-2xl rounded bg-green-600 hover:bg-green-900 transition-colors uppercase text-center">{{ $ProductCount }}</p>
        </div>
        <div class="bg-yellow-500 text-white p-4 rounded tex shadow-xl shadow-black">
            ...
            <p class="my-3 mb-0 ml-12 mr-12 p-2 text-2xl rounded bg-yellow-600 hover:bg-yellow-900 transition-colors uppercase text-center">12</p>
        </div>
    </div>
